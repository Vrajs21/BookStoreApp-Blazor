...
namespace BookStoreApp.API.Migrations
{
    ...
    [Migration("20241230133206_seeded1")]
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.ApiUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f8467d80-e0a7-44ba-bdc7-f278d5d4f699",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBwwNEuvZtJEyH47NqeuIKvgRTWQQftRUTKLRSxrBok+TtMElNkP1udFMUcnDDWC5w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "023d4e76-c522-4f97-bd62-840979726c7c",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0c8fb63e-30f4-4591-a83b-7e20dad7c863",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEm02jxdNj/SClB4OAyHojnowAHASXSmrwP5kE2EuSww1RKbBUf1isxyXH2nsPHpmw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e21834f6-caee-4e2e-8d08-c9c64ecfc269",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Author", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Authors__3214EC07B5DD6607");
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Book", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Books__3214EC071CEA0A03");

                    b.HasIndex("AuthorId");

                    b.HasIndex(new[] { "Isbn" }, "UQ__Books__447D36EAB0E3C90D")
                        .IsUnique();
